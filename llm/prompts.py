...
BATCH_ENTITY_SYSTEM_PROMPT = (
    ...
    "инструкции. Обрабатывай каждый блок, включая повторные упоминания в приложениях, "
    "таблицах, подписях и реквизитах. Для каждого блока верни каждое уникальное значение "
